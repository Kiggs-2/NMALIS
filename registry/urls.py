...
urlpatterns = [
    ...
    path("renewal/practitioner/payment/", views.practitioner_payment_step, name="practitioner_payment_step"),
    path("renewal/practitioner/initiate-payment/", views.practitioner_payment_step, name="practitioner_initiate_payment"),
    path("facility/payment/", hospital_views.facility_payment_step, name="facility_payment_step"),
    path("facility/payment/<int:pk>/cancel/", hospital_views.facility_cancel_payment, name="facility_cancel_payment"),
    path("facility/payment/<int:pk>/resend/", hospital_views.facility_resend_payment, name="facility_resend_payment"),
    path("facility/payment/<int:pk>/check/", hospital_views.facility_check_payment, name="facility_check_payment"),
